...
struct RGB black_hot(double value, double min_value, double max_value, void* _)
{
...
struct RGB white_hot(double value, double min_value, double max_value, void* _)
{
    value = CLAMP(value, min_value, max_value);
...
struct RGB table_lookup(double value, double min_value, double max_value, void* table)
{
